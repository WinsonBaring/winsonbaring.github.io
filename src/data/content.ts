...
const projectFacts: Omit<Project, "headline" | "summary">[] = [
  ...
  },
  {
    ...
    steps: ["Describe yourself, your interests and the goals you care about.", "The intended matching flow brings people with common ground into small groups.", "Use the group to have conversations about what you share."],
    result: "A project exploring connections through shared interests and small-group conversations.",
    tags: ["Community", "Shared interests", "In development"],
    image: "iconnek-logo.png",
    url: "https://iconnek-landing.vercel.app",
  },
  {
    slug: "yabs",
    archived: true,
