...
Issue #5: Nine project pages now use conversational headlines, introductions and three short paragraphs. BendMe positioning data verified identical to previous commit; its presentation remains on the existing renderer. Local checks passed. Changes remain local for review.
