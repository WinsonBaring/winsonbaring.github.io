...
- Central promise: Resume AI helps you explain your work experience.
- Concrete experience: You can start with notes about your work, an old resume or projects you want to include. Resume AI helps organize that information into a draft, and you review it before using it in an application.
- Payoff: You have a draft to work on instead of having to decide how to write everything from the beginning.
- Reason to believe: The writing example uses the same facts in both versions to explain how notes could become a draft. It was written to illustrate the process; it wasn’t generated by the live app.
- Main objection: Check each claim before you apply. The wording needs to reflect work you actually did, and a well-written resume still doesn’t guarantee an interview.

### B. Three hero directions

1. **Resume AI helps you explain your work experience.** When you’re writing a resume, you may know what you’ve done but struggle to explain it. Resume AI helps organize that experience into a draft you can edit for the job you’re applying for.
2. **Your work experience, ready for a first draft.** You can start with notes about your work, an old resume or projects you want to include. Resume AI helps organize that information into a draft, and you review it before using it in an application.
3. **Start your next application with the work you have done.** It uses AI-assisted writing to organize your experience and skills. You choose what to include and edit the wording so it accurately describes your work.

Recommended: direction 1. It gives the reader the clearest observable action and result at the scope supported by the project information. The other directions emphasize the recurring use situation and the product mechanism.

### C. Page copy

**Hero:** Resume AI helps you explain your work experience.

When you’re writing a resume, you may know what you’ve done but struggle to explain it. Resume AI helps organize that experience into a draft you can edit for the job you’re applying for.

**Primary CTA:** See the writing example. Jumps to the on-page walkthrough; does not imply public product access.

**You start with your own experience:** You can start with notes about your work, an old resume or projects you want to include. Resume AI helps organize that information into a draft, and you review it before using it in an application.

**How it works:** It uses AI-assisted writing to organize your experience and skills. You choose what to include and edit the wording so it accurately describes your work. The existing project steps are displayed as the short workflow.

**What you can inspect:** The writing example uses the same facts in both versions to explain how notes could become a draft. It was written to illustrate the process; it wasn’t generated by the live app.

**Before you try it:** Check each claim before you apply. The wording needs to reflect work you actually did, and a well-written resume still doesn’t guarantee an interview.
